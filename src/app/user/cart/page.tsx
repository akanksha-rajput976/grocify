    ...
    <div className='w-[95%] sm:w-[90%] md:w-[80%] mx-auto mt-8 mb-24 relative'>
        ...
        <span className='hidden sm:inline'>Back to Home</span>
          ...
          <motion.h2
            ...
            className='text-2xl sm:text-3xl md:text-4xl font-bold text-green-700 mb-10 text-center'> 🛒 Your Shopping Cart  </motion.h2>
  {cartData.length==0 ? (
    <motion.div
      initial={{opacity:0,y:10}}
      animate={{opacity:1,y:0}}
          ...
          <div className='grid grid-cols-1 lg:grid-cols-3 gap-8'>
              ...
              <AnimatePresence>
                {cartData.map((item,index)=>(
                  ...
                  >
                    <div className='relative w-28 h-28 sm:h-24 md:w-28 md:h-28 shrink-0
