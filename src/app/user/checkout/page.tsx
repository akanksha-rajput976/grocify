      ...
      const fetchAddress=async()=>{
        ...
        try{
          ...
          setAddress(prev=>({...prev,
            ...
            // fullAddress:result.data.address.display_name,
             city:
    ...
    const handleOnlinePayment=async()=>{
     ...
     const handleCurrentlocation=()=>{
      ...
      navigator.geolocation.getCurrentPosition((pos) => {
        const { latitude, longitude } = pos.coords;
        setPosition([latitude, longitude])
      },(err)=>{console.log('loaction error',err)},{enableHighAccuracy:true,maximumAge:0,
        timeout:10000
      });
    }
     }
      ...
      <div className="grid md:grid-cols-2 gap-8 ">
        ...
        >
          ...
          <div className="space-y-4">
            ...
            <div
              className="relative mt-6 h-82.5 rounded-xl overflow-hidden border
        ...
        animate={{ opacity: 1, x: 0 }}
        transition={{ duration: 0.3 }}
        className='bg-white rounded-2xl shadow-lg hover:shadow-xl tarnsition-all
        duration-300 p-6 border border-gray-100 h-fit'
>
      <h2 className='text-xl font-semibold text-gray-800 mb-4 flex items-center gap-2'><CreditCard className='text-green-600'/>
        Payment Method
      </h2>
