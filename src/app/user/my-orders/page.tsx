...
function MyOrder() {
  ...
  useEffect(()=>{
    ...
    if(loading){
      return (
      <div className='bg-linear-to-b from-white to-gray-100 min-h-screen w-full'>Loading Your Orders... </div>
      )
    }
  ...
  return (
    <div className='bg-linear-to-b from-white to-gray-100 min-h-screen w-full'>
     <div className='max-w-3xl mx-auto px-4 pt-16 pb-10 relative'>
      <div className='fixed top-0 left-0 w-full backdrop-blur-lg
       bg-white/70 shadow-sm border-b z-50'>
        <div className='p-2 bg-gray-100 rounded-full hover:bg-gray-200 active:scale-95 transition'>
      ...
      {orders.length===0 ?(
        <div className='pt-20 flex flex-col items-center text-center'>
          ...
          <p className='text-gray-500 text-sm mt-1'>You have not placed any orders yet.</p>
        </div>
