...
function RegisterForm({previousStep}:propType) {
  ...
  return (
    ...
    <motion.h1 
        ...
        className='text-4xl font-extrabold text-green-700 text-center mb-2'>
        Create Account
    </motion.h1>
    <p className='text-gray-600 mb-8 flex items-center'>Join Grocify today<Leaf className='w-5 h-5 text-green-400 mb-2' /></p>
    <motion.form
    ...
    </div>
    {
        (()=>{
            const formValidation=name!=="" && email!=="" && password!=="";          
              ...
              className={`w-full py-3 rounded-xl font-semibold shadow-md transition-all duration-200 inline-flex items-center justify-center gap-2
